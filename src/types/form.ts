...
export interface CalendarValues {
  ...
  is_block_period: boolean
  description: string
  name: string
  ical?: string
  custom_pricing?: CustomPricingValues
}
export interface CustomPricingValues {
  id?: number
  base_rate: number
  weekend_rate: number
  weekly_rate: number
  ...
  advanced_booking_options: {
    max_length_of_stays: [] | null
    arrival_departure_days: [] | null
    allow_same_day_departure_or_arrival: boolean | null
    minimum_delay_before_arrival: number | null
    months_in_advance_receive_reservations: number | null
  }
}

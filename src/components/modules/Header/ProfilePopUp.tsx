        ...
        <div>
          {config === 'Topbar' ? (
            <AppButton
              ...
              style={{...(!isTop && {border: '1px solid #090F1B'})}}
            >
              <Box
              ...
              >
                <Avatar
                  src={
                    !isTop ? '/images/profile-dark.svg' : '/images/profile.png'
                  }
                  variant="square"
              ...
              <Avatar
                ...
                src={!isTop ? '/images/menu-line-dark.svg' : '/images/bar.png'}
                variant="square"
              ></Avatar>
            </AppButton>
          ) : config === 'setting' ? (

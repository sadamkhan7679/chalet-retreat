      ...
      <Box className={classes.MainBox}>
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            ...
            <Typography variant="caption">
              {' '}
              How was the communication between you and the host?{' '}
            </Typography>
          </Box>
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            ...
            <Typography variant="caption">
              {' '}
              Were the indications for check-ins clear and easy?{' '}
            </Typography>
          </Box>
          <Box className={classes.dflexRow + ' ' + classes.topMargin15}>
            <StarIcon
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            ...
            <Typography variant="caption">
              {' '}
              Were the informations about the property accurate?{' '}
            </Typography>
          </Box>
          <Box className={classes.dflexRow + ' ' + classes.topMargin15}>
            <StarIcon
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            ...
            <Typography variant="caption">
              {' '}
              How would you rate per night for for this property offered?{' '}
            </Typography>
          </Box>
          <Box className={classes.dflexRow + ' ' + classes.topMargin15}>
            <StarIcon

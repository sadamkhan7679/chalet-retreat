      ...
      <Box className={classes.MainBox}>
        <Box className={classes.InnerfirstDiv}>
          <Box className={classes.dflexRow2}>
            ...
            <Box className={classes.AltitudeText}>
              <Typography variant="h5"> Altitude-456 </Typography>
              <Box className={classes.dflexRow}>
                <StarIcon style={{color: '#1DAF92', marginRight: '5px'}} />
                <Typography
                  style={{borderRight: '1px solid #D7DDEA', width: '140px'}}
                >
                  4,5{' '}
                  <span
                ...
                <Typography
                  className={classes.grayColor + ' ' + classes.LeftMargin10}
                >
                  {' '}
                  Canada, Quebec{' '}
                </Typography>
              ...
              <Box className={classes.Guest}>
                <Box className={classes.dflexRow}>
                  ...
                  <Typography>
                    <span
                      className={classes.LeftMargin10 + ' ' + classes.grayColor}
              ...
              <Box className={classes.ArrivalBox + ' ' + classes.LeftMargin10}>
                <Typography
                  className={classes.LeftMargin10 + ' ' + classes.topMargin5}
                >
                  <span className={classes.grayColor}>Arrival:</span>8 Sep 2020
                </Typography>
                <Typography
                  className={classes.LeftMargin10 + ' ' + classes.topMargin5}
                  style={{color: '#D7DDEA'}}
                ...
                <Typography
                  className={classes.LeftMargin10 + ' ' + classes.topMargin5}
                >
                  <span className={classes.grayColor}>Departure </span>13 Sep
                  2020
                </Typography>
              </Box>
              <br />
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            ...
            <Typography variant="caption">
              {' '}
              Did the guest left the property in order?{' '}
            </Typography>
          </Box>
          <Box className={classes.dflexRow + ' ' + classes.topMargin15}>
            <StarIcon
              className={classes.LeftMargin10}
              style={{color: '#D7DDEA', marginRight: '5px'}}
            />
            <StarIcon
              className={classes.LeftMargin10}
              style={{color: '#D7DDEA', marginRight: '5px'}}
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            ...
            <Typography variant="caption">
              {' '}
              How was the communication between you and the guest?{' '}
            </Typography>
          </Box>
          <Box className={classes.dflexRow + ' ' + classes.topMargin15}>
            <StarIcon
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            <Typography variant="h5"> Respect of house rules </Typography>
            <Typography variant="caption">
              {' '}
              Did the guest respected the rules you had put in place?{' '}
            </Typography>
          </Box>
          <Box className={classes.dflexRow + ' ' + classes.topMargin15}>
            <StarIcon
        ...
        <Box className={classes.MainRating}>
          <Box className={classes.dColumn + ' ' + classes.topMargin15}>
            <Typography variant="h5">
              {' '}
              Leave a comment about the stay{' '}
            </Typography>
            <Typography variant="caption">
              {' '}
              Leave comments to set expctations for the next hosts.{' '}
            </Typography>
          </Box>
        </Box>
        <br />

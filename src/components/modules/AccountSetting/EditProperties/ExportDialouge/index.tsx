  ...
  return (
    <AppDialog classes={{paper: classes.paper}} open={open}>
      ...
      <Typography variant="caption">
        Copy and paste the link into other iCal applications of other platforms
        and they will automatically keep your listing’s availablility up-to-date
      </Typography>
      ...
      >
        ...
        <Box style={{marginLeft: '10px', marginTop: '0px'}}>
          <Typography variant="caption">
            {' '}
            api.chaletretreat.com/i-1690-dont-1...
          </Typography>
        </Box>
      </Box>
      <AppButton

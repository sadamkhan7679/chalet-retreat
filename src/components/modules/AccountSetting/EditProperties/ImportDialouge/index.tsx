...
import {Platform, PlatformVariant} from 'src/types'
import ActionButtonGroup from '../../../ButtonGroup'
...
// const getPlatformImage = (value: PlatformVariant) => {
//   if (value === "Other Calendar") return "/images/other-calendar-logo.png";

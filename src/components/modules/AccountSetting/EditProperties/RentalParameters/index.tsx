          ...
          <Grid item xs={11} md={6} lg={5}>
            ...
            <Box>
              ...
              >
                ...
                />
                <Typography>
                  Your guests will have to make a request reservation before
                  booking. <br />
                ...
                />
                <Typography>
                  If you apply instant booking to your listings, it will make
                  your role easier and more fast, because you will be able to
                  book guests without have to respond to each individual
                  request.
                  <br /> <br />
                  It will also attract more customers and increase your
                  confirmed reservations. Very important to synchronize your
                  calendars. (Ideal for increasing your booking rate)
                </Typography>
              </RadioGroup>
              <br />
              <AppDivider />
              ...
              <Box className={classes.StayLength}>
                ...
                <Box>
                  <AppButton className={classes.InsideButton}>
                    <span className={classes.spanclass}>
                      <img src="/images/arrowDown.png" />
                    </span>
                  </AppButton>

      ...
      <Box>
        <Grid className={classes.photosGalleryMain}>
          <Grid item xs={11} md={6} lg={5}>
            ...
            <Box className={classes.SmartPricingMainDiv}>
              <Box style={{marginTop: '10px', marginLeft: '15px'}}>
                <Typography variant="h6">
                  ...
                  <span className={classes.GrayColorOnly}> (Optional) </span>{' '}
                </Typography>
                <br />
                <Typography variant="h6">
                  Above this number of guest{' '}
                </Typography>
                <AppButton
                  variant="outlined"
                  style={{
            ...
            <Typography variant="caption" className={classes.GrayColorOnly}>
              Indicate other charges that are specific to your property (ex.
              pet, breakfast and etc.)
            </Typography>
            <Box className={classes.SmartPricingMainDiv}>
              <Box style={{marginTop: '10px', marginLeft: '15px'}}>
                <Typography variant="h6"> Service name </Typography>
                <Box
                  className={classes.SmartPricingMainDiv2}
                  style={{display: 'flex', justifyContent: 'space-between'}}
                >
                  <Typography variant="h6" className={classes.GrayColorOnly}>
                    {' '}
                    Service Price ($){' '}
                  </Typography>
                  <Box
                    ...
                    onClick={() => porps.setEditvalue('Basic Fee')}
                  >
                    <Avatar
                      src={'/images/edit.png'}
            ...
            <AppButton
              variant="outlined"
              style={{borderRadius: '24px', width: '100%', display: 'flex'}}
            >
              {' '}
              <Typography className={classes.GrayColorOnly}>
                <span

        ...
        <Grid className={classes.photosGalleryMain}>
          <Grid item xs={11} md={6} lg={5}>
            ...
            <Typography variant="caption" style={{fontSize: '15px'}}>
              If you need to display a license number on your list to operate in
              your territory, be sure to put it here.
            </Typography>
            <br />
            <br />
            <AppDivider />
            ...
            <Typography variant="caption" style={{fontSize: '15px'}}>
              Indicate the taxes you wish to add to your base price if you have
              not already included them in your base price. Ex.: GST, QST, etc.
            </Typography>
            <br />
            <br />
            <Box

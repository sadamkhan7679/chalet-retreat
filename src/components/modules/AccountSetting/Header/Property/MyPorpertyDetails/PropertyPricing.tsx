        ...
        <Box className={classes.pricing}>
          ...
          >
            ...
            <Box
              ...
              onClick={() => porps.setEditvalue('Rental parameters')}
            >
        ...
        <Box className={classes.ReservationRequest}>
          <Box className={classes.flexRow}>
            ...
            <Box className={classes.BookingPreference2}>
              ...
              <Typography variant="caption">
                {' '}
                Your guest will have to make a request reservation before
                booking.{' '}
              </Typography>
            </Box>
          </Box>
          <Box className={classes.flexRow2}>
            <Box className={classes.ArrivingTime}>
              <Typography
                variant="caption"
                className={classes.BookingPreference3}
              >
                {' '}
                ARRIVING TIME{' '}
              </Typography>
        ...
        <Box className={classes.pricing}>
          ...
          >
            ...
            <Box
              ...
              alignItems="center"
              style={{cursor: 'pointer'}}
              onClick={() => porps.setEditvalue('Basic Pricing')}
            >
              <Avatar src={'/images/edit.png'} className={classes.editIcon} />
              <Typography className={classes.editTitle}> Edit </Typography>
            </Box>
      ...
      <Box className={classes.PricingBoxHeading}>
        ...
        <Box className={classes.ReservationRequest3}>
          <Box className={classes.BasicFee}>
            <Box className={classes.cleaningfee}>
              ...
              <Typography variant="caption" style={{marginLeft: '22px'}}>
                {' '}
                <strong>435$CA</strong>
              </Typography>
            </Box>
        ...
        <Box className={classes.ReservationRequest}>
          ...
          >
            ...
            >
              {' '}
              CHARGE THIS ADDITIONAL AMOUNT PER GUEST PER NIGHT
            </Typography>

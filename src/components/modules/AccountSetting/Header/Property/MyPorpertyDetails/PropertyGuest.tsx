        ...
        <Box className={classes.pricing}>
          ...
          >
            ...
            <Box
              ...
              alignItems="center"
              onClick={() =>
                props.setEditvalue('What number can guest use for support?')
              }
            >
        ...
        <Box className={classes.pricing}>
          ...
          >
            ...
            <Box
              display="flex"
              alignItems="center"
              onClick={() => props.setEditvalue("Guest's Reception")}
            >
              <Avatar src={'/images/edit.png'} className={classes.editIcon} />
              <Typography className={classes.editTitle}> Edit </Typography>
            </Box>
        ...
        <Box className={classes.GuestReceptionDiv}>
          <Box className={classes.flexColumn}>
            ...
            <Box className={classes.flexRowWithoutMarginBottom}>
              <Box className={classes.WifiRow}>
                <Typography variant="caption">
                  <strong> WIFI NETWORK NAME</strong>
                </Typography>
              </Box>
              <Box className={classes.BookingPreference2}>
                <Typography variant="caption">FiberHGW_TP5A3E</Typography>{' '}
                <br />
              </Box>
            </Box>

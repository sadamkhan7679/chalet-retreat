        ...
        <Box className={classes.ProCalendarButton}>
          <Box className={classes.ProCalendarButton2}>
            ...
            <Box className={classes.CalendarButton}>
              <AppButton variant="outlined" className={classes.InsideButton}>
                2021{' '}
          ...
          <Box className={classes.ProCalendarButton2}>
            ...
            <Box
              className={`${classes.CalendarButton} ${classes.mobileBlock2}`}
            ></Box>
            <Box
              className={`${classes.CalendarButton} ${classes.mobileBlock2}`}
            ></Box>
      ...
      <Box className={classes.PricingBoxHeading}>
          ...
          <ThemeProvider theme={theme2}>
            <Box className={classes.logoDiv}>
              <img
                ...
                className={classes.ExternaliCalsImg}
              ></img>
              <ThemeProvider theme={theme2}>
                <Typography variant="h5" className={classes.logoDivTypoGraphy}>
                  Airbnb
                </Typography>
              </ThemeProvider>
            </Box>
          ...
          <Box className={classes.linkDiv}>
            <ThemeProvider theme={theme2}>
              <Typography variant="h6" className={classes.linkTypography}>
                https://fr.airbnb.ca/calendar/ical/49477521.ics?s=a7867
              </Typography>
            </ThemeProvider>
            <Box
              style={{
            ...
            >
              <img
                src="/images/verticleThreeDots.png"
        ...
        <Box className={classes.ExternaliCalsMain}>
          ...
          <Box className={classes.linkDiv}>
            <ThemeProvider theme={theme2}>
              <Typography variant="h6" className={classes.linkTypography}>
                https://fr.glampinghub.ca/calendar/ical/49477521.ics?s=a7867
              </Typography>
            </ThemeProvider>
            <Box
              style={{
        ...
        <Box className={classes.ExternaliCalsMain}>
          ...
          <Box className={classes.linkDiv}>
            <ThemeProvider theme={theme2}>
              <Typography variant="h6" className={classes.linkTypography}>
                https://fr.booking.ca/calendar/ical/49477521.ics?s=a7867
              </Typography>
            </ThemeProvider>
            <Box
              style={{
        ...
        <Box className={classes.ExternaliCalsMain}>
          ...
          <Box className={classes.linkDiv}>
            <ThemeProvider theme={theme2}>
              <Typography variant="h6" className={classes.linkTypography}>
                https://fr.vrbo.ca/calendar/ical/49477521.ics?s=a7867
              </Typography>
            </ThemeProvider>
            <Box
              style={{
        ...
        <Box className={classes.ExternaliCalsMain}>
          <ThemeProvider theme={theme2}>
            <Box className={classes.logoDiv}>
              <img
                src="/images/other-calendar-logo.png"
                className={classes.ExternaliCalsImg}
              ></img>
              <ThemeProvider theme={theme2}>
                <Typography
                  variant="h5"
                  className={classes.logoDivTypoGraphy2}
          ...
          <Box className={classes.linkDiv}>
            <ThemeProvider theme={theme2}>
              <Typography variant="h6" className={classes.linkTypography}>
                https://fr.othercalendar.ca/calendar/ical/49477521.ics?s=a7867
              </Typography>
            </ThemeProvider>
            <Box
              style={{

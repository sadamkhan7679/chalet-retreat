  ...
  return (
    <>
      ...
      <Box className={drawerStyles.root}>
        <Typography
          variant="body1"
          style={{fontWeight: 600, fontSize: '18px', lineHeight: '32px'}}
        >
          Filters
        </Typography>
      ...
      <Box className={drawerStyles.root}>
        ...
        <Box
          className={drawerStyles.filterAccordion}
      ...
      <Box
        className={clsx(
          drawerStyles.root,
          classes.menuWrapper,
          drawerStyles.moreFiltersMobile,
        )}
      >
        <MoreFiltersComp
          setMoreFiltersSM={setMoreFiltersSM}
          inMobileFilter={true}
        />
      </Box>
      <Box className={drawerStyles.root}>

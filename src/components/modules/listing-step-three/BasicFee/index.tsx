...
const BasicFee: React.FC = () => {
  ...
  const onNext = () => {
    ...
    if (basicFee.id) {
      ...
      addBasicFee({basicFee, propertyId: property.id})
        .then((result) => {
                ...
                <AppTooltip
                  title={
                    <AppTypography
                      ...
                      variant="caption"
                    >
                      Costs related to the maintenance of the property will be
                      added to the total of each reservation.
                    </AppTypography>
                  }
                />
              </span>
                ...
                <AppTooltip
                  title={
                    <AppTypography
                      ...
                      variant="caption"
                    >
                      In case of damage, your guests will be responsible up to
                      this amount.
                    </AppTypography>
                  }
                />

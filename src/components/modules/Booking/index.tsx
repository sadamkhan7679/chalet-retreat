...
const index = () => {
  ...
  return (
    <React.Fragment>
      {addNumber && (
        <AddNumber
          description={addNumber}
          setDescription={setAddNumber}
          setVerification={setVerification}
        />
      )}
      {addPayment && (
        <AddPayment description={addPayment} setDescription={setAddPayment} />
      )}
        ...
        <Box className={classes.FirstBox}>
          <Box className={classes.firstSection}>
            ...
            <Box className={classes.RowDirection}>
              ...
              <Typography
                variant="h6"
                style={{marginLeft: '95px', fontSize: '14px'}}
              >
                11:00 AM
              </Typography>
            </Box>
            ...
            <Box className={classes.RowDirection}>
              ...
              <Typography variant="caption" className={classes.Dates}>
                From September 20th to September 22nd 2021
              </Typography>
            </Box>
            <Box className={classes.RowDirection}>
              <Typography
            ...
            <AppDivider />
            <br />
            <Typography variant="h5">Required for your trip</Typography>
            <br />
            <Box
              className={classes.RowDirection}
              style={{justifyContent: 'space-between'}}
            >
              ...
              <br />
              <Button
                style={{border: '1px solid #EAEEF5', borderRadius: '24px'}}
            ...
            <Box>
              ...
              <Box style={{width: '100%'}}>
                ...
                <textarea
                  placeholder="Do you want to say anything to your host?"
                  style={{
                    width: '100%',
                    height: '156px',
                    border: '1px solid #EAEEF5',
            ...
            <Box>
              ...
              <Typography variant="caption" className={classes.grayColor}>
                ...
                <br /> Any refund will be at the discretion of the host if you
        ...
        <Box className={classes.SecondBox}>
            ...
            <Box className={classes.innerBox}>
              <Box className={classes.TreeHouseMain}>
                <Box style={{width: '30%', height: '100px'}}>
                  <Avatar
                    src="/images/properties/rustic-chalets.png"
                    style={{
                      width: '100%',
                      height: '100%',
                      borderRadius: '12px',
          ...
          <Box className={classes.RefundableSecurity}>
            <Box className={classes.RefundableInner}>
              ...
              <Typography variant="caption" className={classes.grayColor}>
                Charged 7 days before your arrival. We are gonna refund your
                security deposit 5 days after your stay.{' '}
              </Typography>
              <Typography
                variant="h6"
                style={{color: '#1DAF92', marginTop: '10px'}}
              >
                $50.00{' '}
              </Typography>
            </Box>

...
const ReactInputVerificationCode = dynamic(
  import('react-input-verification-code'),
  {ssr: false},
)
          ...
          >
            <Box style={{marginLeft: '20px', marginTop: '10px'}}>
              ...
              <Typography variant="caption" style={{color: '#5A6987'}}>
                <strong>We sent the code by SMS to </strong>
                <span style={{color: '#1DAF92'}}>+1 (514) 717-9969</span>
                <br />
                We will send you reservation requests, reminders and other
                notifications. <br />
                This number should be able to receive text messages or calls.
              </Typography>
              <br />
              ...
              <Box className={classes.TryAgain} style={{}}>
                <Typography style={{color: 'black', marginRight: '5px'}}>
                  You did ’t receive it?
                </Typography>
                <Typography style={{color: '#1DAF92'}}>Try again</Typography>
              </Box>
              <br />
              <Box
                style={{

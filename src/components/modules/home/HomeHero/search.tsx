...
const SearchBox: React.FC<ISearchBoxProps> = (props) => {
  ...
  const handleSearch = (): void => {
    ...
    if (router.route !== TO_SEARCH_RESULTS_PAGE)
  ...
  return (
    ...
    >
      <Box
        ...
        style={{
          maxWidth: isSmallSize ? '100%' : undefined,
      ...
      <AppButton
        variant="contained"
        className={clsx(classes.searchPrimaryBtn, classes.searchButtonStyle)}
        color="primary"
      ...
      >
        {
          inTopBar ? (
            ...
            <img src="/images/search-icon-white.svg" alt="search-icon-white" />
          )
          //  <SearchIcon />
        }
      </AppButton>

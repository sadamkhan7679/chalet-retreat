...
export const useStyles = makeStyles(
  ({palette, breakpoints}) => ({
    ...
    root: {
      background: `linear-gradient(90deg, rgba(9, 15, 27, 0.4) 0%, rgba(0, 0, 0, 0) 100%, rgba(9, 15, 27, 0) 100%), linear-gradient(180deg, rgba(9, 15, 27, 0.4) 0%, rgba(9, 15, 27, 0) 100%), url(/images/home-hero.jfif) no-repeat center`,
      maxHeight: '640px',
      [breakpoints.up(800)]: {
        height: '640px',
      },
  ...
  ({palette, breakpoints}) => ({
    ...
    menuWrapper: {
      ...
      '& .MuiPopover-paper': {
        ...
        boxShadow:
          '0px 48px 80px -48px rgba(49, 50, 94, 0.12), 0px 64px 132px -32px rgba(49, 50, 94, 0.08)',
        borderRadius: '16px',
        marginLeft: '-18px',
        '& ul': {
          paddingTop: 0,
    ...
    flexibleDateBtn: ({isSmallSize, inTopBar}: Props) => ({
      ...
      lineHeight: '24px',
      color: '#364259',
      ...(!isSmallSize && !inTopBar && {top: '495px !important'}),
      ...(!isSmallSize && !inTopBar && {left: '-254px !important'}),
      ...(!isSmallSize &&
        inTopBar && {left: '-172px !important', top: '425px !important'}),

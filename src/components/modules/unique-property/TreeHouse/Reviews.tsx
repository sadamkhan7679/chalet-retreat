...
const Reviews = [
  {
    ...
    date: 'August 2021',
    description:
      "Luc's place was very clean and nice to stay at. Great location and I would definitely stay here again. The pictures are accurate.",
  ...
  },
  {
    ...
    date: 'August 2021',
    description:
      'This place is gorgeous, very clean and best location for the perfect view of downtown. ',
    profileUrl: '/images/Image.png',
  },
  {
    id: 3,
    ...
    date: 'August 2021',
    description:
      'A very comfortable place with a good and convenient location, and a spectacular view of the city. I would stay here again. Also, Yan was a grea...',
    profileUrl: '/images/Image.png',
  },
]
...
const Review = ({visible, handleClose}: Props) => {
                ...
                >
                  {Reviews.map((items, index) => {
                    return (
                      <Box
                        key={index}
                        className={`${classes.dFlex} ${classes.marginLeft}`}
                      ...
                      >
                        ...
                        >
                          ...
                          <Typography color="textSecondary" variant="body2">
                            {' '}
                            <span className={classes.blackColor}>4,5</span>
                            <span> (24 Review)</span>
                          </Typography>
                        </Box>
                        <br />

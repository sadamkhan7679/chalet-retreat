...
export const getSearchResults = (state: RootState) =>
  state.propertySearch.searchResults

export const getSearchData = (state: RootState) =>
  state.propertySearch.searchData

export const getSelectedProperty = (state: RootState) =>
...
export const getSelectedGuests = (state: RootState) =>
  state.propertySearch.selectedGuests

export const getSelectedAmenities = (state: RootState) =>
  state.propertySearch.selectedAmenities

export const getSelectedSearchPageNo = (state: RootState) =>
  state.propertySearch.selectedSearchPageNo

//property filters

export const getSortByFilter = (state: RootState) =>
  state.propertySearch.sortByFilter

export const getMoreFilters = (state: RootState) =>
